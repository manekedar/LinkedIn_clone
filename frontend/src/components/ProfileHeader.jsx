...
const ProfileHeader = ({ userData, onSave, isOwnProfile }) => {
    ...
    const [editedData, setIsEditedData] = useState({});
    ...
    const { data: acceptRequest } = useMutation({
    ...
    const handleImageChange = (e) => {
        ...
        if(file) {
            ...
            reader.onloadend = () => {
                setIsEditedData((prev) => ({ ...prev, [e.target.name]: reader.result} ));
            };
          ...
          <div className="relative -mt-20 mb-4">
           ...
           <div className="text-center mb-4">
             {isEditing ? (
                ...
                onChange={(e) => setIsEditedData({ ...editedData, name: e.target.value })}
             ...
             {isEditing ? (
                ...
                onChange={(e) => setIsEditedData({ ...editedData, headline: e.target.value })}
             ...
             <div className="flex justify-center items-center mt-2">
                 <MapPin size={16} className="text-gray-500 mr-1"/>
                   {isEditing ? (
                    ...
                    onChange={(e) => setIsEditedData({ ...editedData, location: e.target.value} )}
